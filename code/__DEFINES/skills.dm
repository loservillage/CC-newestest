...
//Crafting global resultant skills
#define CRAFTING_LEVEL_MIN -10
#define CRAFTING_LEVEL_SPOIL -2
#define CRAFTING_LEVEL_AWFUL -1
#define CRAFTING_LEVEL_CRUDE 0
#define CRAFTING_LEVEL_ROUGH 1
#define CRAFTING_LEVEL_COMPETENT 2
#define CRAFTING_LEVEL_FINE 3
#define CRAFTING_LEVEL_FLAWLESS 4
#define CRAFTING_LEVEL_LEGENDARY 5
#define CRAFTING_LEVEL_MAX 10
